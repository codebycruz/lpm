...
function PackageCard({ pkg }: { pkg: Package }) {
	...
	return (
		<a href={`/registry/${pkg.name}/`} class="flex flex-col gap-3 p-5 rounded-xl border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02] hover:bg-black/[0.04] dark:hover:bg-white/[0.04] transition">
			...
			<div class="flex items-center gap-2 mt-1 rounded-lg bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 px-3 py-2">
				<code class="text-xs font-mono flex-1 text-black/70 dark:text-white/70">{installCmd}</code>
